        ...
        {isGoals ? (
          <>
            ...
            <button
              ...
              className='goalsLink' onClick={(e) => { window.location.href = "/profile" }}>Update my goals</button>
          </>
        ) : (
          <button
            style={{
            ...
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
            className='goalsLink' onClick={(e) => { window.location.href = "/profile" }}>Set my goals!</button>
        )}
      </div>
